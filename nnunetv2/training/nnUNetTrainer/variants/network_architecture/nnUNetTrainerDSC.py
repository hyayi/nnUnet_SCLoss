...
if __name__ == '__main__':
    ...
    data = torch.randn(1, 1, 256, 256).cuda()  # Example input
    ng_tube_model = ng_tube_model.cuda()
    output = ng_tube_model(data)
    print(f"NG Tube Model output shape: {output[0].shape if isinstance(output, list) else output.shape}")
    # print(ng_tube_model)
